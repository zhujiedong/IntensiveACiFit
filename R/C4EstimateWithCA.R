...
#' @param ACi     Gas exchange measurement from LI-6800 equipment. It is a
#' dataframe iput. Ci with the unit of ppm. 
...
C4EstimateWithCA = function(ACi, alpha1 = 0.15, x = 0.4, 
    ...
    startp[6]), fn2, lower=c(0,0,0,0,0,0), upper=c(200, 600, 20, 30, 200,200))
    ...
    Vcmax25 = Parameters[1]/(exp(51.89*(Tleaf-25)/(298.15*0.008314*(273.1+
    Tleaf))))
